...
<?php
if ($errors > 0) {
    print "<script>ShowBox('Ошибка', 'Возникла ошибка создания структуры таблицы. Пожалуйста, прочитайте приведенное выше сообщение, чтобы помочь отладить проблему.', 'red', '', true);</script>";
} else {
    print "<script>ShowBox('Успех', 'Таблицы были успешно созданы', 'green', '', true);</script>";
}
?>
