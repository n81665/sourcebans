								...
								<table width="100%" border="0">
									{foreach from=$ban.commentdata item=commenta}
									 ...
									 {/if}
									  ...
									  <tr>
										<td colspan='3'>
											<span style="font-size:6pt;color:grey;">последнее редактирование {$commenta.edittime} by {if !empty($commenta.editname)}{$commenta.editname}{else}<i><font color="#677882">Admin deleted</font></i>{/if}</span>
										</td>
									  </tr>
									  {/if}
									  {/foreach}
