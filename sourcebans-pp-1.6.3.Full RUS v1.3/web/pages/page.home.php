...
SourceBans 1.4.11
Copyright � 2007-2014 SourceBans Team - Part of GameConnect CGR
...
while (!$res->EOF) {
    ...
    $info['popup']    = "ShowBox('Заблокированный игрок: " . $info['name'] . "', '" . $info['name'] . " попытался войти на<br />' + document.getElementById('" . $info['server'] . "').title + '<br />в " . $info['date'] . "<br /><div align=middle><a href=" . $info['search_link'] . ">Нажмите здесь, чтобы узнать подробности о бане.</a></div>', 'red', '', true);";
